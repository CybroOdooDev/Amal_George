...
class ManagerApproval(models.Model):
    ...
    is_button_view = fields.Boolean(string="Button view",
                                         help="Button for approve button")
    is_button_view_cancel = fields.Boolean(string="Cancel Button",
    ...
    def action_approve(self):
        ...
        self.is_button_view_cancel = False
    ...
    def action_manager_cancel(self):
        ...
        self.is_button_view_cancel = True
        self.is_button_view = False
