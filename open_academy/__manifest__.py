...
###############################################################################
{
    'name': "Odoo 18 Development Tutorials",
    'version': '18.0.1.0.0',
    'summary': """
        This module containing Odoo13, Odoo14, odoo15, odoo16,odoo17 Tutorials, and 
    ...
    'depends': ['base', 'board', 'website_slides', 'contacts'],
    'data': [
        ...
        'data/slide_channel_data_v17.xml',
        'data/slide_channel_data_v18.xml',
    ...
    'assets': {
        'web.assets_backend': [
            'open_academy/static/src/js/open_academy_board_layout.js',
            'open_academy/static/src/scss/open_academy_dashboard.scss',
        ],
        'web.assets_unit_tests': [
            'open_academy/static/tests/**/*.test.js',
        ],
    },
    'license': 'AGPL-3',
    'installable': True,
